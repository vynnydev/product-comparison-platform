...
public class Product {
     ...
     */
    public void update(Product updatedData) {
        ...
        if (updatedData.getRating() != null) {
            this.rating = updatedData.getRating();
        }
        if (updatedData.getCategory() != null) {
            this.category = updatedData.getCategory();
        }
        if (updatedData.getInStock() != null) {
            this.inStock = updatedData.getInStock();
        }
        if (updatedData.getSpecifications() != null) {
            this.specifications = updatedData.getSpecifications();
        }
    }
